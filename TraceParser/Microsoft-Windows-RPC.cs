...
namespace Microsoft.Diagnostics.Tracing.Parsers
{
    ...
    public sealed class MicrosoftWindowsRPCTraceEventParser : TraceEventParser 
    {
        ...
        public event Action<DebugArgs_V1TraceData> Debug
        {
            add
            {
                RegisterTemplate(new DebugArgs_V1TraceData(value, 4, 3, "Debug", DebugTaskGuid, 0, "", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<Debug10Args_V1TraceData> Debug10
        {
            add
            {
                RegisterTemplate(new Debug10Args_V1TraceData(value, 10, 3, "Debug", DebugTaskGuid, 0, "", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<Debug10Args_V1TraceData> Debug11
        {
            add
            {
                RegisterTemplate(new Debug10Args_V1TraceData(value, 11, 3, "Debug", DebugTaskGuid, 0, "", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<DebugStartArgs_V1TraceData> DebugStart
        {
            add
            {
                RegisterTemplate(new DebugStartArgs_V1TraceData(value, 12, 3, "Debug", DebugTaskGuid, 1, "Start", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<DebugStopArgs_V1TraceData> DebugStop
        {
            add
            {
                RegisterTemplate(new DebugStopArgs_V1TraceData(value, 13, 3, "Debug", DebugTaskGuid, 2, "Stop", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<FunctionTraceStartArgs_V1TraceData> FunctionTraceStart
        {
            add
            {
                RegisterTemplate(new FunctionTraceStartArgs_V1TraceData(value, 14, 4, "FunctionTrace", FunctionTraceTaskGuid, 1, "Start", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<FunctionTraceStart16Args_V1TraceData> FunctionTraceStart16
        {
            add
            {
                RegisterTemplate(new FunctionTraceStart16Args_V1TraceData(value, 16, 4, "FunctionTrace", FunctionTraceTaskGuid, 1, "Start", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<FunctionTraceStopArgs_V1TraceData> FunctionTraceStop
        {
            add
            {
                RegisterTemplate(new FunctionTraceStopArgs_V1TraceData(value, 15, 4, "FunctionTrace", FunctionTraceTaskGuid, 2, "Stop", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<RpcClientCallStartArgs_V1TraceData> RpcClientCallStart
        {
            add
            {
                RegisterTemplate(new RpcClientCallStartArgs_V1TraceData(value, 5, 1, "RpcClientCall", RpcClientCallTaskGuid, 1, "Start", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<RpcClientCallStopArgs_V1TraceData> RpcClientCallStop
        {
            add
            {
                RegisterTemplate(new RpcClientCallStopArgs_V1TraceData(value, 1, 1, "RpcClientCall", RpcClientCallTaskGuid, 2, "Stop", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<RpcClientCallStop7Args_V1TraceData> RpcClientCallStop7
        {
            add
            {
                RegisterTemplate(new RpcClientCallStop7Args_V1TraceData(value, 7, 1, "RpcClientCall", RpcClientCallTaskGuid, 2, "Stop", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<RpcServerCallArgs_V1TraceData> RpcServerCall
        {
            add
            {
                RegisterTemplate(new RpcServerCallArgs_V1TraceData(value, 2, 2, "RpcServerCall", RpcServerCallTaskGuid, 0, "", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<RpcServerCallStartArgs_V1TraceData> RpcServerCallStart
        {
            add
            {
                RegisterTemplate(new RpcServerCallStartArgs_V1TraceData(value, 6, 2, "RpcServerCall", RpcServerCallTaskGuid, 1, "Start", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<RpcClientCallStop7Args_V1TraceData> RpcServerCallStop
        {
            add
            {
                RegisterTemplate(new RpcClientCallStop7Args_V1TraceData(value, 8, 2, "RpcServerCall", RpcServerCallTaskGuid, 2, "Stop", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<task_0Args_V1TraceData> task_0
        {
            add
            {
                RegisterTemplate(new task_0Args_V1TraceData(value, 3, 0, "task_0", task_0TaskGuid, 0, "", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        public event Action<RpcClientCallStop7Args_V1TraceData> task_09
        {
            add
            {
                RegisterTemplate(new RpcClientCallStop7Args_V1TraceData(value, 9, 0, "task_0", task_0TaskGuid, 0, "", ProviderGuid, ProviderName));
            }
            remove
            {
        ...
        protected override void EnumerateTemplates(Func<string, string, EventFilterResponse> eventsToObserve, Action<TraceEvent> callback)
        {
            if (s_templates == null)
            {
                ...
                templates[0] = new RpcClientCallStopTraceData(null, 1, 1, "RpcClientCall", RpcClientCallTaskGuid, 2, "Stop", ProviderGuid, ProviderName);
                templates[1] = new RpcServerCallTraceData(null, 2, 2, "RpcServerCall", RpcServerCallTaskGuid, 0, "", ProviderGuid, ProviderName);
                templates[2] = new task_0TraceData(null, 3, 0, "task_0", task_0TaskGuid, 0, "", ProviderGuid, ProviderName);
                templates[3] = new DebugTraceData(null, 4, 3, "Debug", DebugTaskGuid, 0, "", ProviderGuid, ProviderName);
                templates[4] = new RpcClientCallStartTraceData(null, 5, 1, "RpcClientCall", RpcClientCallTaskGuid, 1, "Start", ProviderGuid, ProviderName);
                templates[5] = new RpcServerCallStartTraceData(null, 6, 2, "RpcServerCall", RpcServerCallTaskGuid, 1, "Start", ProviderGuid, ProviderName);
                templates[6] = new RpcClientCallStopTraceData(null, 7, 1, "RpcClientCall", RpcClientCallTaskGuid, 2, "Stop", ProviderGuid, ProviderName);
                templates[7] = new RpcServerCallStopTraceData(null, 8, 2, "RpcServerCall", RpcServerCallTaskGuid, 2, "Stop", ProviderGuid, ProviderName);
                templates[8] = new task_0TraceData(null, 9, 0, "task_0", task_0TaskGuid, 0, "", ProviderGuid, ProviderName);
                templates[9] = new DebugTraceData(null, 10, 3, "Debug", DebugTaskGuid, 0, "", ProviderGuid, ProviderName);
                templates[10] = new DebugTraceData(null, 11, 3, "Debug", DebugTaskGuid, 0, "", ProviderGuid, ProviderName);
                templates[11] = new DebugStartTraceData(null, 12, 3, "Debug", DebugTaskGuid, 1, "Start", ProviderGuid, ProviderName);
                templates[12] = new DebugStopTraceData(null, 13, 3, "Debug", DebugTaskGuid, 2, "Stop", ProviderGuid, ProviderName);
                templates[13] = new FunctionTraceStartTraceData(null, 14, 4, "FunctionTrace", FunctionTraceTaskGuid, 1, "Start", ProviderGuid, ProviderName);
                templates[14] = new FunctionTraceStopTraceData(null, 15, 4, "FunctionTrace", FunctionTraceTaskGuid, 2, "Stop", ProviderGuid, ProviderName);
                templates[15] = new FunctionTraceStartTraceData(null, 16, 4, "FunctionTrace", FunctionTraceTaskGuid, 1, "Start", ProviderGuid, ProviderName);
